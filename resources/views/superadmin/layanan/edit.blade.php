...
<div class="row">
    <div class="col-12">
        <form method="post" action="/superadmin/layanan/{{$data->id}}">
            @csrf
            @method('PUT')
            <div class="row">
                        ...
                        <div class="card-body">
                            ...
                            <div class="col-sm-10"> 
                                ...
                                <div class="custom-control custom-checkbox">
                                  <input class="custom-control-input" type="checkbox" id="customCheckbox{{$item->id}}" name="syarat[]" value="{{$item->id}}" {{$data->persyaratan->whereIn('id', $item->id)->first() == null ? '':'checked'}}>
